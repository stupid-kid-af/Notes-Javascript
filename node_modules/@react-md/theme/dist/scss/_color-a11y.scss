...
/// Boolean if the newer contrast ration defaults should be used. This basically
/// will try to choose colors with a higher aspect ratio for all the default
...
/// @param {Color} front - The foreground color that should be compared to
/// the background color for contrast ratio.
...
/// @param {Number} min-contrast [$rmd-theme-default-contrast-ratio] - The
/// minimum contrast that should be applied. The min contrast for normal text
/// should be 4.5 while large or 14px bold text should be 3.1. See the link for
/// contrasts for more information.
...
/// Determines if the provided color should have a light or dark contrast using
/// the luminance algorithm to maintain a required contrast ratio for
/// accessibility.
///
/// @param {Color} color - The color to test.
/// @param {Number} min-contrast [$rmd-theme-default-contrast-ratio] - The
...
/// should be 4.5 while large or 14px bold text should be 3.1. See the link for
/// contrasts for more information.
/// @returns {String} - The string 'dark' if the color is considered light, or
...
/// Compares a color to a provided light and dark color. If the
/// `$rmd-theme-better-contrast-colors` variable is `true`, the color with the
/// bigger contrast ratio will be chosen. If the variable is `false`, the light
/// color will be returned when it meets the minimum contrast ratio and fallback
/// to the dark color.
///
/// @example scss - Better Contrast Enabled
///   @use "@react-md/theme/dist/scss/color-palette" as colors;
...
/// @param {Color} light-color [$rmd-white-base] - A light color to try to use
/// @param {Color} dark-color [$rmd-white-base] - A dark color to try to use
/// @param {Boolean} enabled [$rmd-theme-better-contrast-colors] - Boolean if
/// the new/better contrast ratios should be used. When this is false, it will
/// return the lighter color as long as it meets the minimum contrast ratio even
/// if the darker color would have a greater contrast ratio.
/// @since 2.4.0
/// @returns {Color} Either the `$light-color` or `$dark-color` depending on
/// contrast ratios.
