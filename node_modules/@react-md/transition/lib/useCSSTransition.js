...
exports.useCSSTransition = void 0;
var classnames_1 = __importDefault(require("classnames"));
var constants_1 = require("./constants");
var getClassNames_1 = require("./getClassNames");
...
function useCSSTransition(_a) {
    ...
    var _d = (0, useTransition_1.useTransition)({
        ref: propRef,
        appear: appear,
        repaint: true,
        timeout: timeout,
    ...
    var classNames = (0, getClassNames_1.getClassNames)(propClassNames, (0, getTimeout_1.getTimeout)(timeout, appear));
    var isEntering = stage === constants_1.ENTERING;
    var isEnter = isEntering || stage === constants_1.ENTER;
    var isEntered = stage === constants_1.ENTERED;
    var isExiting = stage === constants_1.EXITING;
    var isExit = isExiting || stage === constants_1.EXIT;
    var isExited = stage === constants_1.EXITED;
    return [
        rendered,
        {
            ref: ref,
            className: (0, classnames_1.default)(className, 
