...
var getNextStage_1 = require("./getNextStage");
var getTimeout_1 = require("./getTimeout");
var getTimeoutDuration_1 = require("./getTimeoutDuration");
/**
 *
 * @internal
 */
var reducer = function (state, action) {
    switch (action) {
        ...
        case constants_1.UNMOUNT:
            return { stage: constants_1.EXITED, rendered: false, appearing: false };
        default:
            return state;
    }
};
...
function useTransition(_a) {
    ...
    var _e = (0, react_1.useReducer)(reducer, INITIAL_STATE, getInitialState(transitionIn, temporary, appear)), _f = _e[0], stage = _f.stage, rendered = _f.rendered, appearing = _f.appearing, dispatch = _e[1];
    ...
    var timeout = (0, getTimeout_1.getTimeout)(propTimeout, appear);
    var _g = (0, utils_1.useEnsuredRef)(propRef), nodeRef = _g[0], refHandler = _g[1];
    var disableEnterExitTransition = (0, react_1.useRef)(!appear || !transitionIn);
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (duration > 0) {
            dispatch(transitionIn ? constants_1.ENTER : constants_1.EXIT);
        }
        else {
            dispatch(transitionIn ? constants_1.ENTERED : constants_1.EXITED);
        }
    ...
    (0, react_1.useEffect)(function () {
        ...
        var nextStage = (0, getNextStage_1.getNextStage)(stage);
        if (stage === nextStage) {
            if (stage === constants_1.EXITED && temporary) {
                dispatch(constants_1.UNMOUNT);
            }
            return;
        }
        var duration = (0, getTimeoutDuration_1.getTimeoutDuration)(stage, timeout.appear, timeout.enter, timeout.exit, appearing);
        if (duration <= 0) {
            dispatch(nextStage);
            return;
        }
