 ...
 */
exports.CrossFade = (0, react_1.forwardRef)(function CrossFade(_a, forwardedRef) {
    ...
    var _f = (0, useCrossFade_1.useCrossFade)({
        ref: forwardedRef,
        appear: appear,
    ...
    if (!wrap && (0, react_1.isValidElement)(children)) {
        var child = react_1.Children.only(children);
        return (0, react_1.cloneElement)(child, {
            ref: ref,
            className: (0, classnames_1.default)(child.props.className, className),
        });
    }
