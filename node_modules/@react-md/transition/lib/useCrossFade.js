...
function useCrossFade(_a) {
    ...
    return (0, useCSSTransition_1.useCSSTransition)({
        appear: appear,
        timeout: constants_1.CROSS_FADE_TIMEOUT,
        classNames: constants_1.CROSS_FADE_CLASSNAMES,
