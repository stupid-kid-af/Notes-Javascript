...
function Collapse(_a) {
    ...
    var _h = (0, useCollapse_1.useCollapse)(collapsed, {
        appear: appear,
        temporary: temporary,
        className: className,
        timeout: timeout,
    ...
    return (0, react_1.cloneElement)(child, __assign(__assign({}, transitionProps), { style: transitionStyle ? __assign(__assign({}, transitionStyle), childStyle) : childStyle, className: (0, classnames_1.default)(transitionProps.className, child.props.className) }));
}
