...
var block = (0, utils_1.bem)("rmd-typography");
/**
 ...
 */
exports.Text = (0, react_1.forwardRef)(function Text(_a, ref) {
    var _b;
    ...
    var className = (0, classnames_1.default)(block((_b = {},
        _b[type] = true,
    ...
    return (0, react_1.createElement)(getComponent(component, type), __assign(__assign({}, props), { className: className, ref: ref }), children);
});
