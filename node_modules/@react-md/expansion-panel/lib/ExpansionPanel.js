...
var card_1 = require("@react-md/card");
var transition_1 = require("@react-md/transition");
var utils_1 = require("@react-md/utils");
var ExpansionPanelHeader_1 = require("./ExpansionPanelHeader");
var block = (0, utils_1.bem)("rmd-expansion-panel");
/**
 * The expansion panel renders a header element (that is just a button) and
 * dynamically shows content once expanded.
 */
exports.ExpansionPanel = (0, react_1.forwardRef)(function ExpansionPanel(_a, ref) {
    ...
    return (react_1.default.createElement(card_1.Card, __assign({}, props, { id: id + "-container", ref: ref, fullWidth: fullWidth, className: (0, classnames_1.default)(block({ expanded: expanded, "margin-top": marginTop }), className) }),
        customHeader || (react_1.default.createElement(ExpansionPanelHeader_1.ExpansionPanelHeader, { "aria-disabled": disabled || undefined, id: id, ref: headerRef, style: headerStyle, className: headerClassName, icon: expanderIcon, expanded: expanded, onClick: onExpandClick, disableTransition: disableTransition }, header)),
        react_1.default.createElement(transition_1.Collapse, { collapsed: !expanded, timeout: disableTransition ? 0 : undefined, temporary: !persistent },
            react_1.default.createElement(card_1.CardContent, { id: contentId, "aria-labelledby": id, role: "region", style: contentStyle, className: contentClassName, disableSecondaryColor: disableSecondaryColor, disablePadding: disablePadding, disableExtraPadding: true }, children))));
});
