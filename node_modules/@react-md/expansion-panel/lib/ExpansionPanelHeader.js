 ...
 */
exports.ExpansionPanelHeader = (0, react_1.forwardRef)(function ExpansionPanelHeader(_a, ref) {
    ...
    var icon = (0, icon_1.useIcon)("expander", propIcon);
    return (react_1.default.createElement(button_1.UnstyledButton, __assign({}, props, { ref: ref, "aria-expanded": expanded || undefined, className: (0, classnames_1.default)(block("header"), className) }),
        children,
