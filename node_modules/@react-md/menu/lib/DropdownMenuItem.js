...
var useItemVisibility_1 = require("./useItemVisibility");
/**
 * The `DropdownMenuItem` component is used to be able to render nested dropdown menus.
 */
exports.DropdownMenuItem = (0, react_1.forwardRef)(function DropdownMenuItem(_a, ref) {
    ...
    var id = props.id;
    var dropdownIcon = (0, icon_1.useIcon)("forward", propDropdownIcon);
    var _j = (0, useItemVisibility_1.useItemVisibility)({
        onClick: propOnClick,
    ...
    if (!disableDropdownIcon && dropdownIcon && !rightAddon) {
        rightAddon = react_1.default.createElement(icon_1.IconRotator, { rotated: visible }, dropdownIcon);
    }
    var anchor = propAnchor;
    if (!anchor) {
        anchor = horizontal ? utils_1.BELOW_INNER_RIGHT_ANCHOR : utils_1.TOP_RIGHT_ANCHOR;
    }
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(MenuItem_1.MenuItem, __assign({}, props, { ref: ref, "aria-haspopup": "menu", "aria-expanded": visible ? "true" : undefined, role: "button", onClick: onClick, onKeyDown: onKeyDown, rightAddon: rightAddon }), children),
        menuRenderer({
...
if (process.env.NODE_ENV !== "production") {
    try {
        ...
        exports.DropdownMenuItem.propTypes = {
