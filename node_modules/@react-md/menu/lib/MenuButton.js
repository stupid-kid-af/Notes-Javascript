...
var ToggleChildren_1 = require("./ToggleChildren");
var block = (0, utils_1.bem)("rmd-menu-button");
/**
...
exports.MenuButton = (0, react_1.forwardRef)(function MenuButton(_a, ref) {
    ...
    var actionClassName = (0, app_bar_1.useActionClassName)({ first: first, last: last, inheritColor: inheritColor });
    return (react_1.default.createElement(button_1.Button, __assign({}, props, { ref: ref, "aria-haspopup": ariaHasPopup, "aria-expanded": visible ? "true" : undefined, className: (0, classnames_1.default)(block(), (_b = {},
            _b[actionClassName] = first || last || inheritColor || asAppBarAction,
            _b), className) }),
        react_1.default.createElement(ToggleChildren_1.ToggleChildren, { visible: visible, dropdownIcon: dropdownIcon, disableDropdownIcon: disableDropdownIcon || buttonType === "icon" }, children)));
});
