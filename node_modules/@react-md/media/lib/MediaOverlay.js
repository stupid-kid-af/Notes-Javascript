 ...
 */
exports.MediaOverlay = (0, react_1.forwardRef)(function MediaOverlay(_a, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: (0, classnames_1.default)("rmd-media-overlay rmd-media-overlay--" + position, className) }), children));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.MediaOverlay.propTypes = {
