...
export declare type RippleEvent<E extends HTMLElement> = Pick<React.MouseEvent<E>, "target" | "currentTarget" | "type"> & Partial<Pick<React.MouseEvent<E>, "pageX" | "pageY" | "button">> & Partial<Pick<React.KeyboardEvent<E>, "key">> & Partial<Pick<React.TouchEvent<E>, "touches">>;
