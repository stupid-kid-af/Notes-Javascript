...
var block = (0, utils_1.bem)("rmd-avatar");
/**
...
exports.Avatar = (0, react_1.forwardRef)(function Avatar(_a, ref) {
    ...
    var img;
    if (src || imgProps) {
        img = (react_1.default.createElement("img", __assign({ src: src, alt: alt, referrerPolicy: referrerPolicy }, imgProps, { className: (0, classnames_1.default)(block("image"), imgProps === null || imgProps === void 0 ? void 0 : imgProps.className) })));
    }
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block((_b = {}, _b[color] = color, _b)), className) }),
        img,
        children));
});
