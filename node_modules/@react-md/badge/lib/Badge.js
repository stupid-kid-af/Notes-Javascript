...
var block = (0, utils_1.bem)("rmd-badge");
/**
...
exports.Badge = (0, react_1.forwardRef)(function Badge(_a, ref) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block((_b = {}, _b[theme] = theme !== "clear", _b)), className) }), children));
});
