 ...
 * notifications.
 */
exports.BadgedButton = (0, react_1.forwardRef)(function BadgedButton(_a, ref) {
    ...
    var id = props.id;
    var buttonChildren = (0, icon_1.useIcon)("notification", propButtonChildren);
    var badgeId = propBadgeId || "";
    if (!badgeId && id) {
        badgeId = id + "-badge";
    }
    var describedBy = propDescribedBy;
    if (!(0, isEmpty_1.isEmpty)(children, disableNullOnZero)) {
        describedBy = (0, classnames_1.default)(describedBy, badgeId);
    }
