 ...
 */
export declare type ResetQueue<M extends Message> = () => readonly M[];
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const MessageQueueContext: import("react").Context<readonly Message[]>;
/**
 * This hook will allow you to get the current queue. This probably shouldn't be
 * used that much.
 */
export declare function useQueue<M extends Message>(): readonly M[];
