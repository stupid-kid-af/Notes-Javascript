 ...
 * @internal
 */
export declare function handleAddMessage<M extends Message = ToastMessage>(state: readonly M[], message: M, duplicates: DuplicateBehavior): readonly M[];
/**
 * @internal
 */
export declare function reducer<M extends Message = ToastMessage>(state: readonly M[], action: MessageActions<M>): readonly M[];
