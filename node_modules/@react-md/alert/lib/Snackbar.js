...
var block = (0, utils_1.bem)("rmd-snackbar");
exports.Snackbar = (0, react_1.forwardRef)(function Snackbar(_a, ref) {
    var _b;
    ...
    return (react_1.default.createElement(portal_1.ConditionalPortal, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId },
        react_1.default.createElement("div", __assign({}, props, { role: "status", ref: ref, className: (0, classnames_1.default)(block((_b = {}, _b[position] = true, _b)), className) }), children)));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.Snackbar.propTypes = {
