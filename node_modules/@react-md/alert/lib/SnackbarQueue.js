...
function SnackbarQueueT(_a, ref) {
    ...
    var toast = queue[0];
    var visible = (0, MessageQueueContext_1.useMessageVisibility)();
    var _b = (0, MessageQueueContext_1.useMessageQueueActions)(), popMessage = _b.popMessage, hideMessage = _b.hideMessage, startTimer = _b.startTimer;
    var content = null;
    if (toast) {
        ...
        if (providedAction) {
            ...
            if ((0, react_1.isValidElement)(providedAction) || t !== "object") {
...
exports.SnackbarQueue = (0, react_1.forwardRef)(SnackbarQueueT);
