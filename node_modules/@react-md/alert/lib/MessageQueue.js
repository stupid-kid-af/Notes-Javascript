...
function MessageQueue(_a) {
    ...
    return (react_1.default.createElement(MessageQueueContext_1.AddMessageContext.Provider, { value: addMessage },
        react_1.default.createElement(MessageQueueContext_1.MessageQueueActionsContext.Provider, { value: actions },
            react_1.default.createElement(MessageQueueContext_1.MessageVisibilityContext.Provider, { value: visible },
                react_1.default.createElement(MessageQueueContext_1.MessageQueueContext.Provider, { value: queue }, children),
                react_1.default.createElement(SnackbarQueue_1.SnackbarQueue, __assign({}, props, { queue: queue }))))));
}
