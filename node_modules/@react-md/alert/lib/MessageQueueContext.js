 ...
 * @internal
 */
exports.AddMessageContext = (0, react_1.createContext)(function () {
    throw new Error("Attempted to create a message without initializing the MessageQueue component.");
});
/**
 * @internal
 */
exports.MessageVisibilityContext = (0, react_1.createContext)(false);
/**
...
function useAddMessage() {
    return (0, react_1.useContext)(exports.AddMessageContext);
}
...
function useMessageVisibility() {
    return (0, react_1.useContext)(exports.MessageVisibilityContext);
}
exports.useMessageVisibility = useMessageVisibility;
/**
 * @internal
 */
exports.MessageQueueActionsContext = (0, react_1.createContext)({
    popMessage: function () {
...
function useMessageQueueActions() {
    ...
    return (0, react_1.useContext)(exports.MessageQueueActionsContext);
}
exports.useMessageQueueActions = useMessageQueueActions;
/**
 * @internal
 */
exports.MessageQueueContext = (0, react_1.createContext)([]);
/**
 * This hook will allow you to get the current queue. This probably shouldn't be
 * used that much.
 */
function useQueue() {
    return (0, react_1.useContext)(exports.MessageQueueContext);
}
