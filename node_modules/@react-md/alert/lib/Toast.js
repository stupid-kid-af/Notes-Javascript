 ...
 * queue.
 */
exports.Toast = (0, react_1.forwardRef)(function Toast(_a, ref) {
    ...
    return (react_1.default.createElement(CSSTransition_1.default, { in: visible, appear: true, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: timeout, classNames: classNames, mountOnEnter: true, unmountOnExit: true },
        react_1.default.createElement("div", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({
                stacked: stacked,
            ...
            react_1.default.createElement("span", { className: block("message", { action: action }) }, children),
            action && (react_1.default.createElement("span", { className: block("action", { stacked: stacked }) }, action)))));
});
