...
var block = (0, utils_1.bem)("rmd-list-subheader");
/**
 ...
 */
exports.ListSubheader = (0, react_1.forwardRef)(function ListSubheader(_a, ref) {
    var className = _a.className, _b = _a.inset, inset = _b === void 0 ? false : _b, props = __rest(_a, ["className", "inset"]);
    return (react_1.default.createElement("li", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({ inset: inset }), className) })));
});
