 ...
 */
exports.ListItemLink = (0, react_1.forwardRef)(function ListItemLink(_a, ref) {
    var _b;
    ...
    var height = (0, getListItemHeight_1.getListItemHeight)({
        height: propHeight,
        leftAddon: leftAddon,
    ...
    return (react_1.default.createElement(Component, __assign({}, props, handlers, { ref: ref, className: (0, classnames_1.default)("rmd-list-item rmd-list-item--clickable rmd-list-item--link", (_b = {},
...
if (process.env.NODE_ENV !== "production") {
    try {
        ...
        exports.ListItemLink.propTypes = {
