...
exports.defaultMiniNavigationItemRenderer = void 0;
var react_1 = __importDefault(require("react"));
var classnames_1 = __importDefault(require("classnames"));
var divider_1 = require("@react-md/divider");
...
var defaultMiniNavigationItemRenderer = function (itemProps, item, _a) {
    ...
    if (divider && parentId === null) {
        return react_1.default.createElement(divider_1.Divider, { key: key });
    }
    ...
    var overrides = getItemProps(__assign(__assign({}, item), { focused: focused, selected: selected, expanded: expanded }));
    var children = (overrides && overrides.children) || undefined;
    if (typeof children === "undefined") {
        children = getItemLabel(item, labelKey);
    }
    return (react_1.default.createElement(tree_1.TreeItem, __assign({ key: key }, props, { as: as, to: to, href: href, isLink: isLink, contentComponent: contentComponent, style: (_b = overrides === null || overrides === void 0 ? void 0 : overrides.style) !== null && _b !== void 0 ? _b : style, className: (0, classnames_1.default)("rmd-layout-nav__mini-item", (_c = overrides === null || overrides === void 0 ? void 0 : overrides.className) !== null && _c !== void 0 ? _c : className), liStyle: (_d = overrides === null || overrides === void 0 ? void 0 : overrides.liStyle) !== null && _d !== void 0 ? _d : liStyle, liClassName: (_e = overrides === null || overrides === void 0 ? void 0 : overrides.liClassName) !== null && _e !== void 0 ? _e : liClassName, textChildren: false }),
        leftAddon,
        react_1.default.createElement(typography_1.SrOnly, null, children)));
};
