...
var styles = (0, utils_1.bem)("rmd-layout-mini-wrapper");
/**
...
function MiniLayoutWrapper(_a) {
    ...
    var _b = (0, LayoutProvider_1.useLayoutConfig)(), fixedAppBar = _b.fixedAppBar, isMiniable = _b.isMiniable;
    ...
    return (react_1.default.createElement("div", __assign({}, containerProps, { className: (0, classnames_1.default)(!miniHidden && mini && styles(), containerProps === null || containerProps === void 0 ? void 0 : containerProps.className) }),
        mini && miniNavigation,
        children));
}
