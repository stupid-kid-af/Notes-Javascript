...
var styles = (0, utils_1.bem)("rmd-layout-main");
/**
 ...
 */
exports.LayoutMain = (0, react_1.forwardRef)(function LayoutMain(_a, forwardedRef) {
    ...
    if ((0, utils_1.useIsUserInteractionMode)("keyboard") &&
        typeof propTabIndex === "undefined") {
        tabIndex = -1;
    }
    var _h = (0, LayoutProvider_1.useLayoutConfig)(), layout = _h.layout, visible = _h.visible, fixedAppBar = _h.fixedAppBar;
    var navOffset = propNavOffset;
    if (typeof navOffset === "undefined") {
        navOffset = visible && !(0, utils_2.isTemporaryLayout)(layout);
    }
    var timeout = propTimeout;
    var prevLayout = (0, react_1.useRef)(layout);
    ...
    var _j = (0, transition_1.useCSSTransition)({
        ref: forwardedRef,
    ...
    var isMiniOffset = mini &&
        ...
        !fixedAppBar &&
        visible &&
        (0, utils_2.isToggleableLayout)(layout);
    return (react_1.default.createElement(Component, __assign({}, props, { ref: ref, tabIndex: tabIndex, className: (0, classnames_1.default)(styles({
            mini: isMini && ((0, utils_2.isTemporaryLayout)(layout) || !visible),
            "nav-offset": isMini,
