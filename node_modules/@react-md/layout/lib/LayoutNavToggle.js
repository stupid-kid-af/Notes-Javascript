 ...
 */
exports.LayoutNavToggle = (0, react_1.forwardRef)(function LayoutNavToggle(_a, forwardedRef) {
    ...
    var _f = (0, transition_1.useCSSTransition)({
        ref: forwardedRef,
        transitionIn: offset,
        temporary: false,
    ...
    return (react_1.default.createElement(app_bar_1.AppBarNav, __assign({ id: baseId + "-nav-toggle" }, props, { "aria-label": ariaLabel, "aria-pressed": ariaPressed, ref: ref, onClick: function (event) {
        ...
        }, buttonType: buttonType, tabIndex: tabIndex, className: (0, classnames_1.default)("rmd-layout-nav-toggle", className) }), children));
});
