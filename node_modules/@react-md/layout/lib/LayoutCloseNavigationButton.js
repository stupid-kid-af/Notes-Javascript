 ...
 * toggleable layouts.
 */
exports.LayoutCloseNavigationButton = (0, react_1.forwardRef)(function LayoutCloseNavigationButton(_a, ref) {
    ...
    var children = (0, icon_1.useIcon)("back", propChildren);
    var _f = (0, LayoutProvider_1.useLayoutConfig)(), baseId = _f.baseId, layout = _f.layout, hideNav = _f.hideNav;
    ...
    var isRendered = rendered !== null && rendered !== void 0 ? rendered : (0, utils_1.isToggleableLayout)(layout);
    if (!isRendered) {
        return null;
    }
