...
exports.defaultNavigationItemRenderer = void 0;
...
var defaultNavigationItemRenderer = function (itemProps, item, treeProps) {
    ...
    if (subheader) {
        return (react_1.default.createElement(list_1.ListSubheader, { key: key, role: "none" }, item.children));
    }
    return (0, tree_1.defaultTreeItemRenderer)(itemProps, item, treeProps);
};
