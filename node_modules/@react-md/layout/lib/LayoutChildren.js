...
function LayoutChildren(_a) {
    ...
    var _d = (0, LayoutProvider_1.useLayoutConfig)(), layout = _d.layout, visible = _d.visible, fixedAppBar = _d.fixedAppBar;
    var mini = (0, utils_1.isMiniLayout)(layout);
    var _e = (0, react_1.useState)(visible), miniHidden = _e[0], setMiniHidden = _e[1];
