...
var LayoutChildren_1 = require("./LayoutChildren");
...
function Layout(_a) {
    ...
    return (react_1.default.createElement(LayoutProvider_1.LayoutProvider, { baseId: id, fixedAppBar: (_c = (_b = props.appBarProps) === null || _b === void 0 ? void 0 : _b.fixed) !== null && _c !== void 0 ? _c : typeof props.appBar === "undefined", phoneLayout: phoneLayout, tabletLayout: tabletLayout, landscapeTabletLayout: landscapeTabletLayout, desktopLayout: desktopLayout, largeDesktopLayout: largeDesktopLayout, defaultToggleableVisible: defaultToggleableVisible },
        react_1.default.createElement(LayoutChildren_1.LayoutChildren, __assign({ id: id }, props))));
}
...
if (process.env.NODE_ENV !== "production") {
    try {
        ...
        var tabletLayouts = __spreadArray(__spreadArray([], phoneLayouts, true), ["toggleable", "toggleable-mini"], false);
        var wideLayouts = __spreadArray(__spreadArray([], tabletLayouts, true), [
            "clipped",
            "floating",
            "full-height",
        ], false);
