...
exports.LayoutAppBarTitle = (0, react_1.forwardRef)(function LayoutAppBarTitle(_a, ref) {
    ...
    return (react_1.default.createElement(app_bar_1.AppBarTitle, __assign({}, props, { id: id, ref: ref, className: (0, classnames_1.default)(styles({ offset: (0, utils_2.isFullHeightLayout)(layout) }), className) }), children));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.LayoutAppBarTitle.propTypes = {
            id: PropTypes.string,
