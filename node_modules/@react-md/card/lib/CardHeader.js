...
exports.CardHeader = (0, react_1.forwardRef)(function CardHeader(_a, ref) {
    ...
    return (react_1.default.createElement("header", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block("header", (_b = {},
            _b[align] = align !== "none",
            _b)), className) }),
        react_1.default.createElement(icon_1.TextIconSpacing, { icon: react_1.default.createElement(CardHeaderAddon_1.CardHeaderAddon, null, beforeChildren) },
            react_1.default.createElement(icon_1.TextIconSpacing, { icon: react_1.default.createElement(CardHeaderAddon_1.CardHeaderAddon, null, afterChildren), iconAfter: true },
                react_1.default.createElement("span", { className: (0, classnames_1.default)(block("header-content"), contentClassName) }, children)))));
});
