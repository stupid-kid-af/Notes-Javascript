...
exports.TableCellContent = (0, react_1.forwardRef)(function TableCellContent(_a, ref) {
    ...
    if (sortOrder !== "none") {
        ...
        icon = react_1.default.createElement(icon_1.IconRotator, { rotated: rotated }, propIcon);
    }
    return (react_1.default.createElement(button_1.UnstyledButton, { id: id, ref: ref, style: style, className: (0, classnames_1.default)(block("child"), className) },
        react_1.default.createElement(icon_1.TextIconSpacing, __assign({}, props, { icon: icon }), children)));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.TableCellContent.propTypes = {
            id: PropTypes.string,
