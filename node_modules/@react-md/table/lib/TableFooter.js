...
exports.TableFooter = (0, react_1.forwardRef)(function TableFooter(_a, ref) {
    ...
    return (react_1.default.createElement(config_1.TableConfigProvider, { value: configuration },
        react_1.default.createElement(footer_1.TableFooterProvider, { value: true },
            react_1.default.createElement("tfoot", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block(), className) }),
