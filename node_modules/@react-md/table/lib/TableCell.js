...
var TableCellContent_1 = require("./TableCellContent");
 ...
 * readers.
 */
exports.TableCell = (0, react_1.forwardRef)(function TableCell(_a, ref) {
    var _b;
    ...
    var sortIcon = (0, icon_1.useIcon)("sort", propSortIcon);
    ...
    var _e = (0, config_1.useTableConfig)({
        hAlign: propHAlign,
        vAlign: propVAlign,
    ...
    var footer = (0, footer_1.useTableFooter)();
    var sticky = (0, sticky_1.useSticky)(propSticky);
    ...
    return (react_1.default.createElement(Component, __assign({}, props, { ref: ref, id: id, "aria-sort": sortOrder === "none" ? undefined : sortOrder, colSpan: colSpan, className: (0, classnames_1.default)(block((_b = {
                grow: grow,
                header: header,
                sticky: sticky,
        ...
        react_1.default.createElement(TableCellContent_1.TableCellContent, { id: id ? id + "-sort" : undefined, icon: sortIcon, iconAfter: sortIconAfter, sortOrder: sortOrder, rotated: sortIconRotated }, children)));
});
