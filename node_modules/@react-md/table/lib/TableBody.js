 ...
 */
exports.TableBody = (0, react_1.forwardRef)(function TableBody(_a, ref) {
    ...
    var _b = (0, config_1.useTableConfig)({
        hAlign: propHAlign,
        vAlign: propVAlign,
    ...
    return (react_1.default.createElement(config_1.TableConfigProvider, { value: configuration },
        react_1.default.createElement("tbody", __assign({}, props, { ref: ref, className: (0, classnames_1.default)("rmd-tbody", className) }), children)));
});
