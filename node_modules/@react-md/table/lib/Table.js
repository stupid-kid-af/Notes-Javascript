...
var block = (0, utils_1.bem)("rmd-table");
/**
 ...
 */
exports.Table = (0, react_1.forwardRef)(function Table(_a, ref) {
    ...
    return (react_1.default.createElement(config_1.TableConfigProvider, { value: configuration },
        react_1.default.createElement("table", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({
                dense: dense,
