...
exports.TableCheckbox = (0, react_1.forwardRef)(function TableCheckbox(_a, ref) {
    ...
    return (react_1.default.createElement(TableCell_1.TableCell, __assign({}, props, { ref: ref, id: cellId, header: false, className: (0, classnames_1.default)("rmd-table-cell--checkbox", className) }),
