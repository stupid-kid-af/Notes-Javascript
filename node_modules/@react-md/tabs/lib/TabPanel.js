 ...
 */
exports.TabPanel = (0, react_1.forwardRef)(function TabPanel(_a, ref) {
    ...
    return (react_1.default.createElement(CSSTransition_1.default, { in: transitionIn && !hidden, appear: appear, enter: enter, exit: exit, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: timeout, classNames: classNames },
        react_1.default.createElement("div", __assign({}, props, { ref: ref, role: "tabpanel", hidden: hidden, className: (0, classnames_1.default)(block(), className) }), children)));
});
