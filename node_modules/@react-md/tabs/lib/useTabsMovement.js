...
exports.useTabsMovement = void 0;
...
function useTabsMovement(_a) {
    ...
    // {!thing && <Tab />}
    var tabs = (0, react_1.useMemo)(function () { return react_1.Children.toArray(children).filter(Boolean); }, [children]);
    ...
    var visibleTabs = (0, react_1.useMemo)(function () {
        return tabs.filter(function (child) { return (0, react_1.isValidElement)(child) && !child.props.disabled; });
    }, [tabs]);
    var _b = (0, react_1.useState)(activeIndex), focusedIndex = _b[0], setFocusedIndex = _b[1];
    (0, react_1.useEffect)(function () {
        setFocusedIndex(activeIndex);
    }, [activeIndex]);
    var _c = (0, utils_1.useKeyboardMovement)(__assign(__assign({}, (horizontal
        ? utils_1.MovementPresets.HORIZONTAL_TABS
        : utils_1.MovementPresets.VERTICAL_TABS)), { onKeyDown: onKeyDown, focusedIndex: focusedIndex, items: visibleTabs, onChange: function (_a) {
            var index = _a.index;
            if (index === -1) {
                return;
            }
...
exports.useTabsMovement = useTabsMovement;
