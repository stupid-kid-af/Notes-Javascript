...
exports.Tab = (0, react_1.forwardRef)(function Tab(_a, propRef) {
    ...
    var _f = (0, utils_1.useResizeObserver)(updateIndicatorStyles, {
        ref: propRef,
    }), refHandler = _f[1];
    return (react_1.default.createElement("button", __assign({}, props, handlers, { ref: active ? refHandler : propRef, "aria-selected": active, "aria-controls": panelId, type: "button", role: "tab", disabled: disabled, className: (0, classnames_1.default)(block({ active: active, stacked: icon && stacked }), className), tabIndex: active ? undefined : -1 }),
        react_1.default.createElement(icon_1.TextIconSpacing, { icon: icon, stacked: stacked, iconAfter: iconAfter },
            react_1.default.createElement("span", { style: contentStyle, className: (0, classnames_1.default)(block("content"), contentClassName) }, children)),
        ripples));
});
