...
exports.TabsList = (0, react_1.forwardRef)(function TabsList(_a, forwardedRef) {
    ...
    var _j = (0, useTabIndicatorStyle_1.useTabIndicatorStyle)({
        style: style,
        ref: forwardedRef,
        align: align,
        itemRefs: itemRefs,
    ...
    return (react_1.default.createElement(useTabIndicatorStyle_1.UpdateIndicatorStylesProvider, { value: updateIndicatorStyles },
        react_1.default.createElement("div", __assign({}, props, { "aria-orientation": orientation, style: mergedStyle, role: "tablist", className: (0, classnames_1.default)(block((_b = {},
                _b[align] = true,
                _b.padded = padded,
