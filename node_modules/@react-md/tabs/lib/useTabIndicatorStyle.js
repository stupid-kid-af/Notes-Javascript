...
exports.useTabIndicatorStyle = exports.useUpdateIndicatorStyles = exports.UpdateIndicatorStylesProvider = void 0;
 ...
 * @internal
 */
exports.UpdateIndicatorStylesProvider = context.Provider;
/**
 * @remarks \@since 2.3.0
 * @internal
 */
...
exports.useUpdateIndicatorStyles = useUpdateIndicatorStyles;
/**
...
function useTabIndicatorStyle(_a) {
    ...
    var prevCSSVars = (0, react_1.useRef)(cssVars);
    var updateCSSVars = (0, react_1.useCallback)(function (itemRefs, activeIndex) {
        var _a;
    ...
    var updateStyles = (0, react_1.useCallback)(function () {
        updateCSSVars(itemRefs, activeIndex);
    ...
    var _c = (0, utils_1.useResizeObserver)(updateStyles, {
        ref: propRef,
    }), tabsRef = _c[0], tabsRefHandler = _c[1];
    var mergedStyle = (0, react_1.useMemo)(function () { return (__assign(__assign({}, style), cssVars)); }, [style, cssVars]);
    return [mergedStyle, tabsRefHandler, tabsRef, updateStyles];
}
exports.useTabIndicatorStyle = useTabIndicatorStyle;
