...
exports.TabPanels = (0, react_1.forwardRef)(function TabPanels(_a, forwardedRef) {
    ...
    var animimatable = (0, react_1.useRef)(persistent && !disableTransition);
    ...
    var _h = (0, utils_1.useEnsuredRef)(forwardedRef), ref = _h[0], refHandler = _h[1];
    (0, react_1.useEffect)(function () {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: refHandler, className: (0, classnames_1.default)(block({
