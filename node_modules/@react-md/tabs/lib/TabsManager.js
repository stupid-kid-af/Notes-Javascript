...
exports.TabsManager = exports.useTabs = void 0;
...
function TabsManager(_a) {
    ...
    var _e = (0, react_1.useState)(defaultActiveIndex), localActiveIndex = _e[0], setActiveIndex = _e[1];
    var handleActiveIndexChange = (0, react_1.useCallback)(function (activeIndex) {
    ...
    var value = (0, react_1.useMemo)(function () { return ({
        ...
        tabs: tabs.map(function (config, i) {
            var tab;
            if (typeof config === "string" || (0, react_1.isValidElement)(config)) {
                tab = { children: config };
            }
            else {
                tab = config;
