...
export declare type InitializedTabConfig = TabConfig & Required<Pick<TabConfig, "id">>;
...
export declare type InitializedTabsManagerContext = Required<TabsManagerContext>;
/**
 ...
 */
export declare function useTabs(): InitializedTabsManagerContext;
export interface TabsManagerProps extends Omit<TabsManagerContext, "activeIndex" | "onActiveIndexChange" | "tabs"> {
    /**
 ...
 */
export declare function TabsManager({ tabsId, defaultActiveIndex, activeIndex: propActiveIndex, onActiveIndexChange, tabs, stacked, iconAfter, children, }: TabsManagerProps): ReactElement;
