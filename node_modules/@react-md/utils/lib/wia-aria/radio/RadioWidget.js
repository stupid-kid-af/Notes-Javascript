 ...
 * @remarks \@since 2.7.0
 */
exports.RadioWidget = (0, react_1.forwardRef)(function RadioGroupRadio(_a, ref) {
    var checked = _a.checked, children = _a.children, props = __rest(_a, ["checked", "children"]);
    return (react_1.default.createElement("span", __assign({}, props, { "aria-checked": checked, ref: ref, role: "radio" }), children));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.RadioWidget.propTypes = {
