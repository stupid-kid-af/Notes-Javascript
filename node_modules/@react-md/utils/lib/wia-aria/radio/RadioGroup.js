...
var tryToSubmitRelatedForm_1 = require("../tryToSubmitRelatedForm");
 ...
 * @remarks \@since 2.7.0
 */
exports.RadioGroup = (0, react_1.forwardRef)(function RadioGroup(_a, ref) {
    var id = _a.id, _b = _a.getRadioStyle, getRadioStyle = _b === void 0 ? utils_1.defaultGetRadioStyle : _b, _c = _a.getRadioClassName, getRadioClassName = _c === void 0 ? utils_1.defaultGetRadioClassName : _c, items = _a.items, currentValue = _a.value, onBlur = _a.onBlur, onFocus = _a.onFocus, onClick = _a.onClick, onChange = _a.onChange, onKeyDown = _a.onKeyDown, props = __rest(_a, ["id", "getRadioStyle", "getRadioClassName", "items", "value", "onBlur", "onFocus", "onClick", "onChange", "onKeyDown"]);
    var refs = items.map(function () { return (0, react_1.createRef)(); });
    ...
    var handleClick = (0, react_1.useCallback)(function (event) {
        ...
        var index = radio
            ...
            : -1;
        if (index !== -1) {
            onChange((0, utils_1.getRadioItemValue)(items[index]));
            /* istanbul ignore next: can't really happen */
    ...
    var handleKeyDown = (0, react_1.useCallback)(function (event) {
        ...
        if ((0, tryToSubmitRelatedForm_1.tryToSubmitRelatedForm)(event)) {
            return;
        }
        ...
        if (index !== -1) {
            ...
            onChange((0, utils_1.getRadioItemValue)(items[nextIndex]));
        }
    }, [onChange, onKeyDown, refs, items]);
    var focusable = (0, react_1.useMemo)(function () { return items.some(function (value) { return (0, utils_1.getRadioItemValue)(value) === currentValue; }); }, [currentValue, items]);
    return (react_1.default.createElement("span", __assign({}, props, { id: id, ref: ref, role: "radiogroup", onBlur: handleBlur, onFocus: handleFocus, onClick: handleClick, onKeyDown: handleKeyDown, tabIndex: -1 }), items.map(function (item, i) {
        var props;
        var value;
        var checked = false;
        var children;
        ...
        return (react_1.default.createElement(RadioWidget_1.RadioWidget, __assign({}, props, { key: value, id: id + "-" + (i + 1), ref: refs[i], style: itemStyle, className: itemClassName, checked: checked, tabIndex: checked || (!focused && !focusable) ? 0 : -1 }), children));
    })));
});
