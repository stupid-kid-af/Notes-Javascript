...
function useActiveDescendantMovement(_a) {
    ...
    var _f = (0, react_1.useState)(defaultFocusedIndex), focusedIndex = _f[0], setFocusedIndex = _f[1];
    var activeId = focusedIndex !== -1 ? getId(baseId, focusedIndex) : "";
    var _g = (0, useKeyboardMovement_1.useKeyboardMovement)(__assign(__assign({}, options), { valueKey: valueKey, getItemValue: getItemValue, focusedIndex: focusedIndex, items: items, onChange: function (data, itemRefs) {
            if (onChange) {
            ...
            if (item && target && target.scrollHeight > target.offsetHeight) {
                (0, scrollIntoView_1.scrollIntoView)(target, item);
            }
