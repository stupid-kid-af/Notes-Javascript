...
exports.useKeyboardMovement = void 0;
var react_1 = require("react");
var loop_1 = require("../../loop");
var useKeyboardSearch_1 = require("../../search/useKeyboardSearch");
...
function useKeyboardMovement(_a) {
    ...
    var keys = (0, react_1.useMemo)(function () { return __spreadArray(__spreadArray(__spreadArray(__spreadArray([], (0, utils_2.transformKeys)(incrementKeys, "increment"), true), (0, utils_2.transformKeys)(decrementKeys, "decrement"), true), (0, utils_2.transformKeys)(jumpToFirstKeys, "first"), true), (0, utils_2.transformKeys)(jumpToLastKeys, "last"), true); }, [incrementKeys, decrementKeys, jumpToFirstKeys, jumpToLastKeys]);
    var itemRefs = (0, react_1.useMemo)(function () { return Array.from(items, function () { return ({ current: null }); }); }, [items]);
    var handleSearch = (0, useKeyboardSearch_1.useKeyboardSearch)({
        items: items,
        valueKey: valueKey,
    ...
    var handleKeyDown = (0, react_1.useCallback)(function (event) {
        ...
        var keyConfig = (0, utils_2.getKeyboardConfig)(event, keys);
        if (!keyConfig || !target) {
            return;
        }
        ...
        var data = {
            ...
            item: items[index],
            items: items,
            query: (0, utils_2.getStringifiedKeyConfig)(keyConfig),
