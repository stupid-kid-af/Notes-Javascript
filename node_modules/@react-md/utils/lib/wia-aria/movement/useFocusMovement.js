...
exports.useFocusMovement = void 0;
...
function useFocusMovement(_a) {
    ...
    var _c = (0, react_1.useState)(defaultFocusedIndex), focusedIndex = _c[0], setFocusedIndex = _c[1];
    var _d = (0, useKeyboardMovement_1.useKeyboardMovement)(__assign(__assign({}, options), { focusedIndex: focusedIndex, onChange: function (data, itemRefs) {
            if (onChange) {
