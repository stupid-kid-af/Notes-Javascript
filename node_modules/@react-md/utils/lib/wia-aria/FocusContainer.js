 ...
 */
exports.FocusContainer = (0, react_1.forwardRef)(function FocusContainer(_a, forwardedRef) {
    ...
    var _k = (0, useEnsuredRef_1.useEnsuredRef)(forwardedRef), ref = _k[0], refHandler = _k[1];
    (0, usePreviousFocus_1.usePreviousFocus)(disableFocusOnUnmount, unmountFocusFallback);
    (0, useFocusOnMount_1.useFocusOnMount)(ref, defaultFocus, disableFocusOnMountScroll, false, disableFocusOnMount);
    var handleKeyDown = (0, useTabFocusWrap_1.useTabFocusWrap)({
