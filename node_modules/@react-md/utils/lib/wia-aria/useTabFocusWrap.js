...
exports.useTabFocusWrap = void 0;
...
function useTabFocusWrap(_a) {
    ...
    var focusables = (0, react_1.useRef)([]);
    var handleKeyDown = (0, react_1.useCallback)(function (event) {
        ...
        if (disableFocusCache || !focusables.current.length) {
            focusables.current = (0, getFocusableElements_1.getFocusableElements)(event.currentTarget);
        }
...
exports.useTabFocusWrap = useTabFocusWrap;
