 ...
 */
function useDir() {
    var _a = (0, react_1.useContext)(context), _root = _a.root, current = __rest(_a, ["root"]);
    return current;
}
...
function Dir(_a) {
    ...
    var root = (0, react_1.useContext)(context).root;
    var _c = (0, react_1.useState)(defaultDir), dir = _c[0], setDir = _c[1];
    ...
    var toggleDir = (0, react_1.useCallback)(function () {
        setDir(function (prevDir) { return (prevDir === "ltr" ? "rtl" : "ltr"); });
    }, []);
    var value = (0, react_1.useMemo)(function () { return ({ root: false, dir: dir, toggleDir: toggleDir }); }, [dir, toggleDir]);
    var child = react_1.Children.only(children);
    if (!root) {
        child = (0, react_1.cloneElement)(child, { dir: dir });
    }
