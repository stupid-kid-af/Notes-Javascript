...
function useTimeout(cb, delay, defaultStarted) {
    ...
    var cbRef = (0, useRefCache_1.useRefCache)(cb);
    var delayRef = (0, useRefCache_1.useRefCache)(delay);
    var timeoutRef = (0, react_1.useRef)();
    var _a = (0, useToggle_1.useToggle)(defaultStarted), enabled = _a[0], start = _a[1], disable = _a[2];
    var clearTimeout = (0, react_1.useCallback)(function () {
