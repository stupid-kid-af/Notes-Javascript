...
exports.GridCell = (0, react_1.forwardRef)(function GridCell(_a, ref) {
    ...
    var _j = (0, useAppSize_1.useAppSize)(), isPhone = _j.isPhone, isTablet = _j.isTablet, isDesktop = _j.isDesktop, isLargeDesktop = _j.isLargeDesktop;
    ...
    var cellClassName = (0, classnames_1.default)(block("cell", (_h = {},
        _h["" + colSpan] = colSpan,
        _h)), className);
