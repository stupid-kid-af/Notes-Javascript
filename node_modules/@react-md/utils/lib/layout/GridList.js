...
exports.GridList = (0, react_1.forwardRef)(function GridList(_a, forwardedRef) {
    ...
    var _h = (0, useGridList_1.useGridList)({
        ref: forwardedRef,
        style: style,
        className: className,
    ...
    if (isRenderFunction(children)) {
        ...
        content = react_1.Children.map(children, function (child) { return child && react_1.default.createElement(GridListCell_1.GridListCell, { clone: clone }, child); });
    }
    else {
        content = children;
    }
    return (react_1.default.createElement(useGridList_1.GridListSizeProvider, { value: gridSize },
        react_1.default.createElement("div", __assign({}, props, gridListProps), content)));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.GridList.propTypes = {
