...
function useGridList(_a) {
    ...
    var _h = (0, useEnsuredRef_1.useEnsuredRef)(propRef), ref = _h[0], mergedRef = _h[1];
    var _j = (0, react_1.useState)(defaultSize || { columns: -1, cellWidth: maxCellSize }), gridSize = _j[0], setGridSize = _j[1];
    var recalculate = (0, react_1.useCallback)(function () {
        ...
        if (target.offsetHeight < target.scrollHeight) {
            width -= (0, scrollbarSize_1.scrollbarSize)("width");
        }
    ...
    var _k = (0, useResizeObserver_1.useResizeObserver)(recalculate, {
        ref: mergedRef,
    ...
    return [
        {
            ref: refHandler,
            style: mergedStyle,
            className: (0, classnames_1.default)("rmd-grid-list", className),
        },
        gridSize,
    ];
}
