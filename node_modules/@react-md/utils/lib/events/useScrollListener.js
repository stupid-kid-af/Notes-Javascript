...
var delegateEvent_1 = require("./delegateEvent");
...
function useScrollListener(_a) {
    ...
    var callback = (0, useRefCache_1.useRefCache)(onScroll);
    (0, react_1.useEffect)(function () {
        if (!enabled) {
            return;
        }
        var eventHandler = (0, delegateEvent_1.delegateEvent)("scroll", element || window, true, options);
