 ...
 * @internal
 */
var modeContext = (0, react_1.createContext)("mouse");
/**
 * @internal
 */
var parentContext = (0, react_1.createContext)(false);
/**
 * @internal
 */
...
function useUserInteractionMode() {
    return (0, react_1.useContext)(modeContext);
}
...
function useIsUserInteractionMode(mode) {
    return (0, useInteractionMode_1.useInteractionMode)() === mode;
}
...
function UserInteractionModeListener(_a) {
    ...
    var mode = (0, useInteractionMode_1.useInteractionMode)();
    if ((0, react_1.useContext)(parentContext)) {
