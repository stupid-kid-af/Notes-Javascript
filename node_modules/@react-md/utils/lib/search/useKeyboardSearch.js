...
function useKeyboardSearch(_a) {
    ...
    var _f = (0, useTempValue_1.useTempValue)("", resetTime), value = _f[0], setValue = _f[1];
    var values = (0, react_1.useMemo)(function () { return items.map(function (item) { return getItemValue(item, valueKey); }); }, [items, getItemValue, valueKey]);
