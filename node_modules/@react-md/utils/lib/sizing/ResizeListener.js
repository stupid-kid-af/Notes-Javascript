...
exports.ResizeListener = void 0;
var useResizeListener_1 = require("./useResizeListener");
/**
...
function ResizeListener(_a) {
    ...
    (0, useResizeListener_1.useResizeListener)({ onResize: onResize, options: options, immediate: immediate, enabled: true });
    return null;
}
