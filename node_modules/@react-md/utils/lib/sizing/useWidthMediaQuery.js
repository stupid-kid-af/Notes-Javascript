...
exports.useWidthMediaQuery = exports.toWidthPart = void 0;
...
function useWidthMediaQuery(_a) {
    ...
    var query = (0, react_1.useMemo)(function () {
        var parts = [(0, exports.toWidthPart)(min, "min"), (0, exports.toWidthPart)(max, "max")]
            .filter(Boolean)
            .join(" and ");
        return "screen and " + parts;
    }, [min, max]);
    return (0, useMediaQuery_1.useMediaQuery)(query);
}
