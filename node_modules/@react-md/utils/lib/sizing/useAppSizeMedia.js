...
exports.useAppSizeMedia = exports.DEFAULT_APP_SIZE = void 0;
var react_1 = require("react");
var constants_1 = require("./constants");
var useOrientation_1 = require("./useOrientation");
var useWidthMediaQuery_1 = require("./useWidthMediaQuery");
...
function useAppSizeMedia(_a) {
    ...
    var matchesDesktop = (0, useWidthMediaQuery_1.useWidthMediaQuery)({ min: desktopMinWidth });
    var matchesLargeDesktop = (0, useWidthMediaQuery_1.useWidthMediaQuery)({ min: desktopLargeMinWidth });
    var matchesTablet = (0, useWidthMediaQuery_1.useWidthMediaQuery)({
        min: tabletMinWidth,
        max: tabletMaxWidth,
    });
    var matchesPhone = (0, useWidthMediaQuery_1.useWidthMediaQuery)({ max: phoneMaxWidth });
    var isDesktop = matchesDesktop;
    var isTablet = !matchesDesktop && matchesTablet;
    var isPhone = !isTablet && !isDesktop && matchesPhone;
    var isLandscape = (0, useOrientation_1.useOrientation)().includes("landscape");
    var isLargeDesktop = matchesLargeDesktop;
    var _j = (0, react_1.useState)(defaultSize), appSize = _j[0], setAppSize = _j[1];
