...
function getFixedPosition(_a) {
    ...
    var _m = (0, getElementRect_1.getElementRect)(element), height = _m.height, elWidth = _m.width;
    if (disableVHBounds) {
    ...
    var _o = (0, createHorizontalPosition_1.createHorizontalPosition)({
        x: anchor.x,
        vw: vw,
        vwMargin: vwMargin,
        xMargin: xMargin,
    ...
    var _p = (0, createVerticalPosition_1.createVerticalPosition)({
        y: anchor.y,
        vh: vh,
        vhMargin: vhMargin,
        yMargin: yMargin,
