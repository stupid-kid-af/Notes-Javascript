...
exports.Chip = (0, react_1.forwardRef)(function Chip(_a, ref) {
    ...
    if (!disableContentWrap) {
        content = (react_1.default.createElement("span", { style: contentStyle, className: (0, classnames_1.default)(block("content"), contentClassName) }, children));
    }
    ...
    return (react_1.default.createElement(Component, __assign({}, (noninteractable ? {} : buttonProps), props, handlers, { ref: ref, className: (0, classnames_1.default)(block((_b = {},
            _b[theme] = true,
            ...
            _b)), className) }),
        react_1.default.createElement(icon_1.TextIconSpacing, { icon: leftIcon, beforeClassName: isHiddenIcon ? "" : undefined },
            react_1.default.createElement(icon_1.TextIconSpacing, { icon: rightIcon, iconAfter: true }, content)),
        ripples));
});
