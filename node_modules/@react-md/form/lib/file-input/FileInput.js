...
exports.FileInput = (0, react_1.forwardRef)(function FileInput(_a, ref) {
    ...
    var icon = (0, icon_1.useIcon)("download", propIcon);
    ...
    if (typeof propChildren === "undefined") {
        children = react_1.default.createElement(typography_1.SrOnly, null, "Upload");
    }
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("label", { htmlFor: id, style: style, className: (0, classnames_1.default)("rmd-file-input-label", className) },
            content,
            ripples)));
});
