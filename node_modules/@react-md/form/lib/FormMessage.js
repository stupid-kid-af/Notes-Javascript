...
exports.FormMessage = (0, react_1.forwardRef)(function FormMessage(_a, ref) {
    ...
    if (!disableWrap && children) {
        message = (react_1.default.createElement("p", { id: id + "-message", style: messageStyle, className: (0, classnames_1.default)(block("message"), messageClassName) }, children));
    }
    return (react_1.default.createElement("div", __assign({}, props, { id: id, ref: ref, "aria-live": role !== "alert" ? "polite" : undefined, role: role, className: (0, classnames_1.default)(block((_b = {
                error: error
            },
            _b[theme] = theme !== "none",
            _b)), className) }),
        message,
        typeof length === "number" && typeof maxLength === "number" && (react_1.default.createElement(FormMessageCounter_1.FormMessageCounter, { id: id + "-counter", style: counterStyle, className: counterClassName }, length + " / " + maxLength))));
});
