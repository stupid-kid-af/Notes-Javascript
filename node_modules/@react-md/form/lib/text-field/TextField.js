...
exports.TextField = (0, react_1.forwardRef)(function TextField(_a, ref) {
    ...
    var _j = (0, useFieldStates_1.useFieldStates)({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    ...
    var _k = (0, FormThemeProvider_1.useFormTheme)({
        theme: propTheme,
        underlineDirection: propUnderlineDirection,
    }), theme = _k.theme, underlineDirection = _k.underlineDirection;
    return (react_1.default.createElement(TextFieldContainer_1.TextFieldContainer, __assign({}, containerProps, { style: style, className: className, ref: containerRef, theme: theme, error: error, active: focused, label: !!label, dense: dense, inline: inline, disabled: disabled, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, leftChildren: leftChildren, rightChildren: rightChildren, underlineDirection: underlineDirection }),
        react_1.default.createElement(FloatingLabel_1.FloatingLabel, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, active: focused, floating: focused || valued || SPECIAL_TYPES.includes(type), valued: valued, dense: dense, disabled: disabled }, label),
        react_1.default.createElement("input", __assign({}, props, { ref: ref, type: type, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange, style: inputStyle, className: (0, classnames_1.default)(block({
