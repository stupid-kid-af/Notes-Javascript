...
exports.defaultGetErrorMessage = exports.RECOMMENDED_NUMBER_STATE_KEYS = exports.RECOMMENDED_STATE_KEYS = void 0;
/**
 * @internal
 * @remarks \@since 2.5.0
 */
 ...
 * @remarks \@since 2.5.0
 */
exports.RECOMMENDED_STATE_KEYS = [
    "badInput",
    "tooLong",
    "valueMissing",
];
 ...
 * @remarks \@since 2.5.0
 */
exports.RECOMMENDED_NUMBER_STATE_KEYS = __spreadArray(__spreadArray([], exports.RECOMMENDED_STATE_KEYS, true), [
    "rangeOverflow",
    "rangeUnderflow",
    "tooShort",
    "typeMismatch",
...
var isRecommended = function (validity, isNumber) {
    var errorable = isNumber
        ? exports.RECOMMENDED_NUMBER_STATE_KEYS
        : exports.RECOMMENDED_STATE_KEYS;
