...
function useNumberField(_a) {
    ...
    var _h = (0, react_1.useState)(defaultValue), number = _h[0], setNumber = _h[1];
    var initial = (0, react_1.useRef)(number);
    var handleBlur = (0, react_1.useCallback)(function (event) {
        ...
        value = (0, utils_1.withinRange)(value, min, max);
    ...
    var handleChange = (0, react_1.useCallback)(function (event) {
        ...
        var input = event.currentTarget;
        input.checkValidity();
        var value = (0, utils_1.withinRange)(event.currentTarget.valueAsNumber, min, max);
    ...
    var _j = (0, useTextField_1.useTextField)({
        id: id,
    ...
    var updateNumber = (0, react_1.useCallback)(function (value) {
