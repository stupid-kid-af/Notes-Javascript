...
exports.Password = (0, react_1.forwardRef)(function Password(_a, ref) {
    ...
    var id = props.id;
    var _e = (0, react_1.useState)("password"), type = _e[0], setType = _e[1];
    ...
    if (!disableVisibility) {
        rightChildren = (react_1.default.createElement(button_1.Button, { id: id + "-password-toggle", "aria-label": visibilityLabel, "aria-pressed": visible, buttonType: "icon", onClick: toggle, style: visibilityStyle, className: (0, classnames_1.default)(block("toggle"), visibilityClassName) }, typeof getVisibilityIcon === "function"
            ? getVisibilityIcon(type)
            : visibilityIcon));
    }
    return (react_1.default.createElement(TextField_1.TextField, __assign({}, props, { className: (0, classnames_1.default)(block({ offset: !disableVisibility }), className), inputClassName: (0, classnames_1.default)(block("input", { offset: !disableVisibility }), inputClassName), ref: ref, type: type, isRightAddon: isRightAddon, rightChildren: rightChildren })));
});
