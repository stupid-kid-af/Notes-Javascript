...
exports.TextArea = (0, react_1.forwardRef)(function TextArea(_a, forwardedRef) {
    ...
    var _m = (0, FormThemeProvider_1.useFormTheme)({
        theme: propTheme,
        underlineDirection: propUnderlineDirection,
    }), theme = _m.theme, underlineDirection = _m.underlineDirection;
    var _o = (0, react_1.useState)(), height = _o[0], setHeight = _o[1];
    if (resize !== "auto" && typeof height === "number") {
        setHeight(undefined);
    }
    var maskRef = (0, react_1.useRef)(null);
    var _p = (0, react_1.useState)(false), scrollable = _p[0], setScrollable = _p[1];
    ...
    var _q = (0, utils_1.useResizeObserver)(updateHeight, {
        ref: maskRef,
        disableHeight: true,
    }), maskRefHandler = _q[1];
    var _r = (0, useFieldStates_1.useFieldStates)({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    ...
    var _s = (0, utils_1.useEnsuredRef)(forwardedRef), ref = _s[0], refHandler = _s[1];
    ...
    var area = (react_1.default.createElement("textarea", __assign({}, props, { ref: refHandler, rows: rows, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange, style: __assign(__assign({}, areaStyle), { height: height }), className: (0, classnames_1.default)(block({
    ...
    var children = area;
    if (resize === "auto") {
        children = (react_1.default.createElement("div", { style: { height: height }, className: container("inner", { animate: animate }) },
            area,
            react_1.default.createElement("textarea", { "aria-hidden": true, defaultValue: value || defaultValue, id: id + "-mask", ref: maskRefHandler, readOnly: true, rows: rows, tabIndex: -1, style: areaStyle, className: (0, classnames_1.default)(block({
                    rn: true,
                    mask: true,
                    floating: label && theme !== "none",
                }), areaClassName) })));
    ...
    return (react_1.default.createElement(TextFieldContainer_1.TextFieldContainer, __assign({}, containerProps, { style: __assign(__assign({}, style), { height: height
                ? "calc(" + PADDING_VARIABLES + " + " + height + "px)"
                : undefined }), className: (0, classnames_1.default)(container({
        ...
        react_1.default.createElement(FloatingLabel_1.FloatingLabel, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, active: focused, floating: focused || valued, valued: valued, dense: dense, disabled: disabled }, label),
        children));
});
