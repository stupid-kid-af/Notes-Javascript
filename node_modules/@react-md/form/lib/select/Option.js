...
var block = (0, utils_1.bem)("rmd-option");
/**
 ...
 */
exports.Option = (0, react_1.forwardRef)(function Option(_a, ref) {
    ...
    return (react_1.default.createElement(list_1.SimpleListItem, __assign({}, props, { ref: ref, role: "option", "aria-selected": selected || undefined, clickable: true, className: (0, classnames_1.default)(block({
            selected: selected,
            focused: focused,
