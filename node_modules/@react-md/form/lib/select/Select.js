...
exports.Select = (0, react_1.forwardRef)(function Select(_a, forwardedRef) {
    ...
    var _y = (0, utils_1.useToggle)(false), visible = _y[0], show = _y[1], hide = _y[2];
    var _z = (0, useFocusState_1.useFocusState)({ onBlur: onBlur, onFocus: onFocus }), focused = _z[0], handleFocus = _z[1], handleBlur = _z[2];
    ...
    var _0 = (0, utils_1.useEnsuredRef)(forwardedRef), ref = _0[0], refHandler = _0[1];
    (0, utils_1.useCloseOnOutsideClick)({
        enabled: visible,
        element: ref.current,
        onOutsideClick: hide,
    });
    var _1 = (0, transition_1.useFixedPositioning)({
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(TextFieldContainer_1.TextFieldContainer, __assign({}, props, { "aria-haspopup": "listbox", "aria-disabled": disabled || undefined, ref: refHandler, role: "button", dense: dense, tabIndex: disabled ? undefined : 0, label: !!label, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: disabled ? undefined : handleKeyDown, onClick: disabled ? undefined : handleClick, theme: theme, error: error, active: focused || visible, inline: inline, disabled: disabled, underlineDirection: underlineDirection, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, rightChildren: rightChildren, className: (0, classnames_1.default)(block({ disabled: disabled }), className) }),
            react_1.default.createElement(FloatingLabel_1.FloatingLabel, { id: labelId, style: labelStyle, className: (0, classnames_1.default)(block("label"), labelClassName), htmlFor: id, error: error, active: valued && (focused || visible), valued: valued, floating: focused || valued || visible, dense: dense, disabled: disabled, component: "span" }, label),
            react_1.default.createElement("span", { id: displayValueId, style: displayLabelStyle, className: (0, classnames_1.default)(block("value", {
                    disabled: disabled,
                    readonly: readOnly,
