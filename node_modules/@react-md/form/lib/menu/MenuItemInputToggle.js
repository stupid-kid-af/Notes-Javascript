 ...
 * @remarks \@since 2.8.0
 */
exports.MenuItemInputToggle = (0, react_1.forwardRef)(function MenuItemInputToggle(_a, ref) {
    ...
    if (type === "switch" && typeof propIcon === "undefined") {
        icon = react_1.default.createElement(SwitchTrack_1.SwitchTrack, { checked: checked });
    }
    else if (icon && type !== "switch") {
        icon = (react_1.default.createElement("span", { className: (0, classnames_1.default)("rmd-toggle", styles("toggle")) },
            react_1.default.createElement(InputToggleIcon_1.InputToggleIcon, { circle: type === "radio", disabled: disabled, overlay: true, checked: checked, indeterminate: indeterminate }, icon)));
    }
    var leftAddon;
    var leftAddonType;
    ...
    return (react_1.default.createElement(list_1.ListItem, __assign({}, props, { disableRipple: true, "aria-disabled": disabled || undefined, "aria-checked": checked, role: type === "radio" ? "menuitemradio" : "menuitemcheckbox", onClick: function (event) {
            onClick === null || onClick === void 0 ? void 0 : onClick(event);
            onCheckedChange(!checked, event);
        }, ref: ref, className: (0, classnames_1.default)(styles({ switch: type === "switch" }), className), tabIndex: tabIndex, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition }), children));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.MenuItemInputToggle.propTypes = {
