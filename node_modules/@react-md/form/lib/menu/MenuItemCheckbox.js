 ...
 * ```
 */
exports.MenuItemCheckbox = (0, react_1.forwardRef)(function MenuItemCheckbox(_a, ref) {
    var propIcon = _a.icon, props = __rest(_a, ["icon"]);
    var icon = (0, icon_1.useIcon)("checkbox", propIcon);
    return (react_1.default.createElement(MenuItemInputToggle_1.MenuItemInputToggle, __assign({}, props, { ref: ref, icon: icon, type: "checkbox" })));
});
