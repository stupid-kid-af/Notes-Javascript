...
var styles = (0, utils_1.bem)("rmd-slider-thumb");
/**
 ...
 * @remarks \@since 2.5.0
 */
exports.SliderThumb = (0, react_1.forwardRef)(function SliderThumb(_a, ref) {
    ...
    var isFirst = index === 0;
    var _m = (0, useDiscreteValueVisibility_1.useDiscreteValueVisibility)({
        active: active,
        animate: animate,
        discrete: discrete,
        disabled: disabled,
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        disabled && (react_1.default.createElement("span", { className: (0, classnames_1.default)(styles(__assign(__assign({}, styleOptions), { mask: true, "mask-h": !vertical, "mask-v": vertical })), className) })),
        react_1.default.createElement("span", __assign({}, props, { id: id, ref: ref, role: "slider", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, "aria-valuetext": getValueText(value) || undefined, "aria-disabled": disabled || undefined, "aria-orientation": (vertical && "vertical") || undefined, tabIndex: tabIndex, onBlur: onBlur, onFocus: onFocus, className: (0, classnames_1.default)(styles(__assign(__assign({}, styleOptions), { "disabled-h": disabled && !vertical, "disabled-v": disabled && vertical })), className) })),
