...
var getJumpValue = function (min, max, step, jump) {
    var steps = (0, exports.getSteps)(min, max, step);
...
var getDragValue = function (_a) {
    ...
    var rounded = (0, utils_1.nearest)(value, minValue, maxValue, steps, range);
    return {
        value: rounded,
...
var getDragPercentage = function (_a) {
    ...
    var thumb1Percentage = dragging && draggingIndex === 0
        ? dragValue
        : (0, utils_1.getPercentage)(min, max, thumb1Value);
    var thumb2Percentage;
    if (typeof thumb2Value === "number") {
        var percentage = (0, utils_1.getPercentage)(min, max, thumb2Value);
