...
var styles = (0, utils_1.bem)("rmd-slider-track");
/**
 ...
 * @remarks \@since 2.5.0
 */
exports.SliderTrack = (0, react_1.forwardRef)(function SliderTrack(_a, ref) {
    var _b;
    ...
    var style = __assign(__assign({}, propStyle), (_b = {}, _b[constants_1.THUMB_1_VAR] = thumb1Percentage, _b[constants_1.THUMB_2_VAR] = thumb2Percentage, _b));
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, style: style, className: (0, classnames_1.default)(styles({
            animate: animate,
            hoverable: !disabled,
            disabled: disabled,
            h: !vertical,
