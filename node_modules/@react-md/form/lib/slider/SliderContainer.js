...
var styles = (0, utils_1.bem)("rmd-slider-container");
/**
 ...
 * @remarks \@since 2.5.0
 */
exports.SliderContainer = (0, react_1.forwardRef)(function SliderContainer(_a, ref) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        label && (react_1.default.createElement("span", __assign({}, labelProps, { id: labelId, className: (0, classnames_1.default)((0, label_1.labelStyles)({ disabled: disabled }), labelProps === null || labelProps === void 0 ? void 0 : labelProps.className) }), label)),
        react_1.default.createElement("div", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(styles({
                h: !vertical,
            ...
            react_1.default.createElement(icon_1.TextIconSpacing, { icon: beforeAddon, stacked: vertical, flexReverse: vertical },
                react_1.default.createElement(icon_1.TextIconSpacing, { icon: afterAddon, iconAfter: true, stacked: vertical, flexReverse: vertical }, children)))));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.SliderContainer.propTypes = {
