...
var styles = (0, utils_1.bem)("rmd-slider-value");
...
function SliderValue(_a) {
    ...
    return (react_1.default.createElement(tooltip_1.Tooltip, __assign({}, props, { portal: portal, className: (0, classnames_1.default)(styles({
            h: !vertical,
            v: vertical,
        }), (_b = {
