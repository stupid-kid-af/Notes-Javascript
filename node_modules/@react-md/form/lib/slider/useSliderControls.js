...
function useSliderControls(_a) {
    ...
    var thumb1Ref = (0, react_1.useRef)(null);
    var thumb2Ref = (0, react_1.useRef)(null);
    var _g = (0, react_1.useState)(false), dragging = _g[0], setDragging = _g[1];
    var _h = (0, react_1.useState)(min), dragValue = _h[0], setDragValue = _h[1];
    var _j = (0, react_1.useState)(null), draggingBy = _j[0], setDraggingBy = _j[1];
    var _k = (0, react_1.useState)(null), draggingIndex = _k[0], setDraggingIndex = _k[1];
    var controlsRef = (0, react_1.useRef)(controls);
    (0, utils_1.useIsomorphicLayoutEffect)(function () {
        controlsRef.current = controls;
    });
    var dir = (0, utils_1.useDir)().dir;
    var isRtl = dir === "rtl";
    var thumb1Value;
    var thumb1Percentage;
    var thumb2Value;
    var thumb2Percentage;
    if ((0, utils_2.isRangeSlider)(controls)) {
        _b = controls.value, thumb1Value = _b[0], thumb2Value = _b[1];
        (_c = (0, utils_2.getDragPercentage)({
            min: min,
            max: max,
        ...
        (thumb1Percentage = (0, utils_2.getDragPercentage)({
            min: min,
            max: max,
            thumb1Value: thumb1Value,
            dragging: dragging,
     ...
     * event handlers
     */
    var drag = (0, react_1.useCallback)(function (event) {
        ...
        if (altKey ||
            ...
            !track ||
            !slider1 ||
            ((0, utils_2.isMouseEvent)(event) && event.button !== 0) ||
            ((0, utils_2.isTouchEvent)(event) && event.changedTouches.length !== 1) ||
            (!(0, utils_2.isMouseEvent)(event) && !(0, utils_2.isTouchEvent)(event))) {
            return;
        }
        ...
        // versions of React
        if (!(0, utils_2.isTouchEvent)(event)) {
        ...
        var clientX;
        var clientY;
        if ((0, utils_2.isMouseEvent)(event)) {
        ...
        setDraggingBy((0, utils_2.isMouseEvent)(event) ? "mouse" : "touch");
        ...
        if ((0, utils_2.isRangeSlider)(controls)) {
            ...
            var _c = (0, utils_2.getDragValue)(__assign(__assign({}, options), { minValue: index === 0 ? min : thumb1Value_1 + step, maxValue: index === 1 ? max : thumb2Value_1 - step })), value = _c.value, current = _c.current;
            setDragValue(current);
            controls.setValue(index === 0 ? [value, thumb2Value_1] : [thumb1Value_1, value]);
        }
        else {
            var _d = (0, utils_2.getDragValue)(options), value = _d.value, current = _d.current;
            setDragValue(current);
    ...
    var handleKeyDown = (0, react_1.useCallback)(function (event) {
        ...
        var controls;
        if ((0, utils_2.isRangeSlider)(controlsRef.current)) {
    ...
    var trackRefHandler = (0, react_1.useCallback)(function (instance) {
        (0, utils_1.applyRef)(instance, ref);
        trackRef.current = instance;
    }, [ref]);
    var thumb1RefHandler = (0, react_1.useCallback)(function (instance) {
        (0, utils_1.applyRef)(instance, propThumb1Ref);
        thumb1Ref.current = instance;
    }, [propThumb1Ref]);
    var thumb2RefHandler = (0, react_1.useCallback)(function (instance) {
        (0, utils_1.applyRef)(instance, propThumb2Ref);
