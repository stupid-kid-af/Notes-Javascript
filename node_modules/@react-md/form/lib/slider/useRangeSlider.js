...
function useRangeSlider(defaultValue, _a) {
    ...
    var jump = (0, react_1.useMemo)(function () { return (0, utils_2.getJumpValue)(min, max, step, propJump); }, [min, max, step, propJump]);
    // since the `currentValue` is a ref, this state is used to force a re-render
    // to get the updated value from the ref.
    var _h = (0, react_1.useState)([]), hack = _h[1];
    var _j = (0, react_1.useState)(defaultValue !== null && defaultValue !== void 0 ? defaultValue : [min, max]), value = _j[0], setValue = _j[1];
    ...
    var increment = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "increment" }); }, [update]);
    var incrementJump = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "increment-jump" }); }, [update]);
    var decrement = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "decrement" }); }, [update]);
    var decrementJump = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "decrement-jump" }); }, [update]);
    var minimum = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "min" }); }, [update]);
    var maximum = (0, react_1.useCallback)(function (index) { return update({ index: index, type: "max" }); }, [update]);
    ...
    var prev = (0, react_1.useRef)({ min: min, max: max, step: step });
    if (prev.current.min !== min ||
        ...
        var steps = (0, utils_2.getSteps)(min, max, step);
        var nextValue = [
            (0, utils_1.nearest)(value[0], min, max, steps),
            (0, utils_1.nearest)(value[1], min, max, steps),
        ];
