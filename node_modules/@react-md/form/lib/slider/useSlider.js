...
function useSlider(defaultValue, _a) {
    ...
    var _j = (0, react_1.useState)(defaultValue !== null && defaultValue !== void 0 ? defaultValue : min), value = _j[0], setValue = _j[1];
    ...
    var incrementJump = (0, react_1.useCallback)(function () {
        setValue(function (prevValue) { return Math.max(min, Math.min(max, prevValue + jump)); });
    }, [min, max, jump]);
    var decrement = (0, react_1.useCallback)(function () {
        setValue(function (prevValue) { return Math.max(min, Math.min(max, prevValue - step)); });
    }, [min, max, step]);
    var decrementJump = (0, react_1.useCallback)(function () {
        setValue(function (prevValue) { return Math.max(min, Math.min(max, prevValue - jump)); });
    }, [min, max, jump]);
    var minimum = (0, react_1.useCallback)(function () {
        setValue(min);
    }, [min]);
    var maximum = (0, react_1.useCallback)(function () {
        setValue(max);
    }, [max]);
    ...
    if (prev.current.min !== min ||
        ...
        var nextValue = (0, utils_1.nearest)(value, min, max, (0, utils_2.getSteps)(min, max, step));
