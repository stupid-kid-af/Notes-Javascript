...
exports.InputToggle = (0, react_1.forwardRef)(function InputToggle(allProps, ref) {
    ...
    var _j = (0, useFocusState_1.useFocusState)({
        onFocus: propOnFocus,
        onBlur: propOnBlur,
    ...
    return (react_1.default.createElement(ToggleContainer_1.ToggleContainer, { style: style, className: className, inline: inline, stacked: stacked },
        iconAfter && labelEl,
        react_1.default.createElement("span", { style: toggleStyle, className: (0, classnames_1.default)(block({
                focused: focused,
                disabled: disabled,
            }), toggleClassName) },
            react_1.default.createElement("input", __assign({}, props, handlers, { ref: ref, style: inputStyle, disabled: disabled, onFocus: onFocus, onBlur: onBlur, className: (0, classnames_1.default)(block("input"), inputClassName) })),
