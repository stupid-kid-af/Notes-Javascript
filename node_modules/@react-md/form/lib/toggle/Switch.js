...
exports.Switch = (0, react_1.forwardRef)(function Switch(_a, ref) {
    ...
    var id = props.id;
    return (react_1.default.createElement(ToggleContainer_1.ToggleContainer, { style: style, className: (0, classnames_1.default)("rmd-switch-container", className), inline: inline, stacked: stacked },
