...
var block = (0, utils_1.bem)("rmd-toggle-container");
/**
 ...
 */
exports.ToggleContainer = (0, react_1.forwardRef)(function ToggleContainer(_a, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({ stacked: stacked, inline: inline }), className) }), children));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.ToggleContainer.propTypes = {
