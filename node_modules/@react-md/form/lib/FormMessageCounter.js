...
exports.FormMessageCounter = void 0;
...
function FormMessageCounter(_a) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { className: (0, classnames_1.default)(block("counter"), className) }), children));
}
