...
exports.Fieldset = (0, react_1.forwardRef)(function Fieldset(_a, ref) {
    ...
    return (react_1.default.createElement("fieldset", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block({ unstyled: unstyled }), className) }),
        react_1.default.createElement("legend", { style: legendStyle, className: (0, classnames_1.default)(block("legend", { "sr-only": legendSROnly }), legendClassName) }, legend),
        children));
});
