...
/** @remarks \@since 2.8.5 */
export declare type StrictMenuItemInputToggleProps = BaseMenuItemInputToggleProps & (({
    type: "checkbox";
 ...
 * @remarks \@since 2.8.0
 */
export declare const MenuItemInputToggle: React.ForwardRefExoticComponent<StrictMenuItemInputToggleProps & React.RefAttributes<HTMLLIElement>>;
export {};
