 ...
 */
exports.TreeGroup = (0, react_1.forwardRef)(function TreeGroup(_a, ref) {
    ...
    return (react_1.default.createElement(transition_1.Collapse, { style: style, className: (0, classnames_1.default)("rmd-tree-group", className), collapsed: collapsed, minHeight: minHeight, minPaddingBottom: minPaddingBottom, minPaddingTop: minPaddingTop, timeout: timeout, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, temporary: temporary },
        react_1.default.createElement(list_1.List, __assign({}, props, { ref: ref, role: "group" }), children)));
});
/* istanbul ignore next */
if (process.env.NODE_ENV !== "production") {
    try {
        var PropTypes = require("prop-types");
        exports.TreeGroup.propTypes = {
