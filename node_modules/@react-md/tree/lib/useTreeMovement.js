...
exports.useTreeMovement = void 0;
var react_1 = require("react");
var utils_1 = require("@react-md/utils");
var useFlattenedTreeList_1 = require("./useFlattenedTreeList");
var useNestedTreeList_1 = require("./useNestedTreeList");
/**
...
function useTreeMovement(_a) {
    ...
    var items = (0, useNestedTreeList_1.useNestedTreeList)(data, sort, rootId);
    var _b = (0, useFlattenedTreeList_1.useFlattenedTreeList)({
        id: id,
        items: items,
    ...
    var _c = (0, utils_1.useActiveDescendantMovement)(__assign(__assign({}, utils_1.MovementPresets.VERTICAL_TREE), { items: visibleItems, baseId: id, getId: function (_baseId, index) {
            ...
            if (item &&
                ...
                (0, utils_1.scrollIntoView)(container, item);
            }
            if (!multiSelect) {
                return;
            }
            var isToStart = query.endsWith(utils_1.JumpMovementKey.ControlShiftHome);
            var isToEnd = query.endsWith(utils_1.JumpMovementKey.ControlShiftEnd);
            ...
            var uniqueSelectedIds = Array.from(new Set(__spreadArray(__spreadArray([], selectedIds, true), jumpSelectedIds, true)));
            ...
            switch (event.key) {
                ...
                case "ArrowRight":
                    ...
                    if (!expandedIds.includes(itemId)) {
                        ...
                        (0, utils_1.scrollIntoView)(event.currentTarget, nextItem);
                    }
                    break;
                case "ArrowLeft":
                    if (isParent && expandedIds.includes(itemId)) {
                        ...
                        (0, utils_1.scrollIntoView)(event.currentTarget, parentItem);
                    }
                    break;
                case "a": {
                ...
                case "*": {
                    ...
                    var nextIds = Array.from(new Set(__spreadArray(__spreadArray([], expandedIds, true), expectedExpandedIds, true)));
    ...
    var lastFocus = (0, react_1.useRef)(0);
    ...
    var handleFocus = (0, react_1.useCallback)(function (event) {
        ...
        if (currentItem && isKeyboard) {
            (0, utils_1.scrollIntoView)(getScrollContainer(event.currentTarget), currentItem);
        }
    ...
    var setActiveId = (0, react_1.useCallback)(function (itemId) {
...
exports.useTreeMovement = useTreeMovement;
