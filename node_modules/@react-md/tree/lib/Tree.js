...
var block = (0, utils_1.bem)("rmd-tree");
 ...
 */
exports.Tree = (0, react_1.forwardRef)(function Tree(// eslint-disable-line @typescript-eslint/no-explicit-any
_a, ref) {
    ...
    var expanderIcon = (0, icon_1.useIcon)("dropdown", propExpanderIcon);
    var _l = (0, useTreeMovement_1.useTreeMovement)({
        id: id,
        data: data,
        sort: sort,
        rootId: rootId,
        ...
        return items.map(function (item, index) {
            ...
            return itemRenderer({
                ...
                renderChildItems: childItems
                    ? function () {
                        return renderChildItems(childItems, depth + 1, __spreadArray(__spreadArray([], parentIndexes, true), [
                            index + 1,
                        ], false));
                    }
                    : undefined,
            }, __assign(__assign({}, item), { visibleIndex: visibleIndex }), __assign({ id: id, expanderLeft: expanderLeft, expanderIcon: expanderIcon, multiSelect: multiSelect, labelKey: labelKey, valueKey: valueKey, getItemLabel: getItemLabel, getItemValue: getItemValue, getItemProps: getItemProps, linkComponent: linkComponent, rootId: rootId }, props));
        });
    };
    return (react_1.default.createElement(list_1.List, __assign({}, props, { ref: ref, id: id, "aria-activedescendant": activeId, "aria-multiselectable": multiSelect || undefined, role: "tree", tabIndex: 0, className: (0, classnames_1.default)(block(), className), onBlur: handleBlur, onFocus: handleFocus, onKeyDown: handleKeyDown }), renderChildItems(items, 0, [])));
});
