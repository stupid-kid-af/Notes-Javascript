...
exports.useTreeItemSelection = void 0;
...
function useTreeItemSelection(defaultSelectedIds, multiSelect) {
    ...
    var _a = (0, react_1.useState)(defaultSelectedIds), selectedIds = _a[0], setSelectedIds = _a[1];
    var onItemSelect = (0, react_1.useCallback)(function (itemId) {
    ...
    var onMultiItemSelect = (0, react_1.useCallback)(function (itemIds) {
