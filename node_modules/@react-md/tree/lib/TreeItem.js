...
var block = (0, utils_1.bem)("rmd-tree-item");
/**
 ...
 */
exports.TreeItem = (0, react_1.forwardRef)(function TreeItem(_a, ref) {
    var _b;
    ...
    var expanderIcon = (0, icon_1.useIcon)("expander", propExpanderIcon);
    var isLink = typeof propIsLink === "boolean"
        ? propIsLink
        : typeof Content !== "string" || Content === "a";
    var _o = (0, states_1.useInteractionStates)({
        disabled: disabled,
    ...
    return (react_1.default.createElement("li", __assign({}, (isLink ? noA11y : a11y), { ref: liRef, style: liStyle, className: (0, classnames_1.default)(block(), liClassName) }),
        react_1.default.createElement(Content, __assign({}, props, (isLink ? a11y : undefined), { ref: ref, className: (0, classnames_1.default)(block("content", (_b = {
                    link: isLink,
