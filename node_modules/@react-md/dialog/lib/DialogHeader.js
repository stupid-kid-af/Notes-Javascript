 ...
 */
exports.DialogHeader = (0, react_1.forwardRef)(function DialogHeader(_a, ref) {
    var children = _a.children, className = _a.className, props = __rest(_a, ["children", "className"]);
    return (react_1.default.createElement("header", __assign({}, props, { ref: ref, className: (0, classnames_1.default)(block("header"), className) }), children));
});
