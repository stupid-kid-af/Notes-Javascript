...
exports.Dialog = (0, react_1.forwardRef)(function Dialog(_a, ref) {
    ...
    var _1 = (0, useNestedDialogFixes_1.useNestedDialogFixes)({
        id: id,
        visible: visible,
    ...
    if (typeof propOverlay === "boolean" ? propOverlay : !isFullPage) {
        ...
        overlayEl = (react_1.default.createElement(overlay_1.Overlay, { id: id + "-overlay", style: overlayStyle, className: (0, classnames_1.default)("rmd-dialog-overlay", overlayClassName), hidden: overlayHidden || disableOverlay, visible: visible, clickable: !modal, onRequestClose: modal ? noop : onRequestClose }));
    }
    var dialog = (react_1.default.createElement(utils_1.FocusContainer, __assign({}, props, { ref: ref, role: isNoneRole ? undefined : role, "aria-modal": (!isNoneRole && !!overlayEl) || undefined, tabIndex: tabIndex, component: component, defaultFocus: defaultFocus, disableTabFocusWrap: isNoneRole || disableTabFocusWrap || disableFocusContainer, disableFocusOnMount: isNoneRole || disableFocusContainer || disableFocusOnMount, disableFocusOnMountScroll: true, disableFocusOnUnmount: isNoneRole || disableFocusContainer || disableFocusOnUnmount, onKeyDown: (0, utils_1.useCloseOnEscape)(onRequestClose, disableEscapeClose || isNoneRole, onKeyDown), className: (0, classnames_1.default)(block({
            centered: isCentered,
    ...
    if (isCentered || forceContainer) {
        ...
        dialog = (react_1.default.createElement("span", { id: id + "-container", style: containerStyle, className: (0, classnames_1.default)("rmd-dialog-container", containerClassName) }, dialog));
    }
    return (react_1.default.createElement(portal_1.ConditionalPortal, { portal: !isNoneRole && portal, portalInto: portalInto, portalIntoId: portalIntoId },
        react_1.default.createElement(react_1.default.Fragment, null,
            overlayEl,
            react_1.default.createElement(CSSTransition_1.default, { appear: !disableTransition && appear, enter: !disableTransition && enter, exit: !disableTransition && exit, in: visible, classNames: classNames, timeout: timeout, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit }, dialog))));
});
