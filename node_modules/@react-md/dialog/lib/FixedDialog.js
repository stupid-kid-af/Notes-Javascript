 ...
 * "Pop out Dialog".
 */
exports.FixedDialog = (0, react_1.forwardRef)(function FixedDialog(_a, ref) {
    ...
    var _f = (0, transition_1.useFixedPositioning)(__assign(__assign({ style: propStyle, transformOrigin: true }, options), { onScroll: /* istanbul ignore next */ function (_event, _a) {
