...
exports.Sheet = (0, react_1.forwardRef)(function Sheet(_a, ref) {
    ...
    var offscreen = (0, react_1.useRef)(!visible && !unmountOnExit && !mountOnEnter);
    ...
    var _0 = (0, react_1.useState)(!visible && !mountOnEnter), hidden = _0[0], setHidden = _0[1];
    if (hidden && visible) {
        setHidden(false);
    }
    ...
    return (react_1.default.createElement(dialog_1.Dialog, __assign({}, props, { ref: ref, type: "custom", role: role, visible: visible, className: (0, classnames_1.default)(block((_b = {
